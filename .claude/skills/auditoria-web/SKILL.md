---
name: auditoria-web
description: Web audit service methodology for arsi.dev — 3 client entry situations (has site not working → Flow A, wants redesign → Flow R, no site → Flow B), the 3-layer model (traffic channels / site / conversion), phase-based roadmaps, and public page copy for arsi.dev/audit.
---
