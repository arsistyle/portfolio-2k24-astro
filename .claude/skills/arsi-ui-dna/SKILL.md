---
name: arsi-ui-dna
description: Neo-brutalist & acid-pop design system for arsi.dev — color tokens (primary #3efa93, secondary #9747ff, tertiary #faaa25, bg #17191b), Syne+Google Sans typography, Y2K sticker system with clip-path geometry. Hard rules: no shadows, no borders on containers, no opacity modifiers, no gradients. Emojis for decorative UI, Tabler Icons for functional UI.
---
