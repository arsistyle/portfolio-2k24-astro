...
export const GET: APIRoute = async () => {
	...
	content += `## Navigation\n`
	content += `- [Home](https://arsi.dev/index.md)\n`
	content += `- [Spanish Version](https://arsi.dev/es/llms.txt)\n\n`

	content += `## Sections\n`
	content += `- [Blog Index](https://arsi.dev/blog/index.md) - Full list of articles.\n`
	content += `- [Projects Index](https://arsi.dev/projects/index.md) - Full list of technical projects.\n\n`

	content += `## Featured Projects\n`
	if (projects.length > 0) {
		projects.slice(0, 5).forEach((project) => {
			content += `- [${project.title}](https://arsi.dev/projects/${project.name}.md) - ${project.description || "Technical project details."}\n`
		})
	}
	content += `\n`
